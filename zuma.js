...
function loadConfig() {
    const defaults = {
        ...
        DOWNLOAD_LINKS: ['https://gitee.com/biglobin/zuma_desktop_agent/releases/download/latest/ZUMAROBOT_RELEASE_STANDARD.zip', 'https://github.com/biglobin/zuma_desktop_agent/releases/download/latest/ZUMAROBOT_RELEASE_STANDARD.zip'],
...
const commands = {
    ...
    async 'cron-start'(args) {
        ...
        const str = "*/40 */minute * * * * *";
        const param_pattern = str.replace('*/minute', args.pattern || '0');
