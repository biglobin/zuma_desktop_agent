...
description: >
  ...
  不做任何推理或扩展。
  触发词：zuma、zuma菜单、zuma帮助、 采集、X 采集、推文采集、小红书发笔记、小红书发贴、截图、截屏、
  定时开启、定时停止、cron 启动、RPA 控制。
download_url: https://gitee.com/biglobin/zuma_desktop_agent  # 用于下载或更新
homepage: https://github.com/biglobin/zuma_desktop_agent     # 项目主页（可用于下载或更新）
---
